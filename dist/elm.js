...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.h, request.bb, true);
		} catch (e) {
...
var author$project$Main$Squart = 1;
var author$project$Main$Test = function (a) {
	return {$: 5, a: a};
};
var elm$core$Maybe$Nothing = {$: 1};
var author$project$User$init = {aI: '', I: '', U: elm$core$Maybe$Nothing, bc: elm$core$Maybe$Nothing};
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{w: false, aC: r.aC, aK: r.aK, e: r.e, h: r.h, i: r.i, j: r.j, bb: r.bb}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{aC: elm$http$Http$emptyBody, aK: r.aK, e: _List_Nil, h: 'GET', i: elm$core$Maybe$Nothing, j: elm$core$Maybe$Nothing, bb: r.bb});
};
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{x: elm$core$Dict$empty, H: false, u: author$project$User$init, O: 1},
		elm$http$Http$get(
			{
				aK: elm$http$Http$expectString(author$project$Main$Test),
				bb: 'http://142.93.47.26:1023/pairs'
			}));
};
										...
										return function (marketHistory) {
											return function (interestRatioNow) {
												return function (baseVolume) {
													return {az: ask, aA: baseVolume, aB: bid, aJ: exchange, aO: high, aP: highVolume24, aS: interestRatioNow, aT: low, aU: marketCup, aV: marketHistory, aW: marketVol24, a7: symbol, be: volume24};
												};
											};
										};
									};
...
var author$project$Data$C = F3(
	function (currentDay, prevDay, twoPrevDay) {
		return {aG: currentDay, a0: prevDay, a9: twoPrevDay};
	});
...
var author$project$Main$Table = 0;
...
var author$project$User$ResponseFail = {$: 5};
...
var elm$http$Http$post = function (r) {
	return elm$http$Http$request(
		{aC: r.aC, aK: r.aK, e: _List_Nil, h: 'POST', i: elm$core$Maybe$Nothing, j: elm$core$Maybe$Nothing, bb: r.bb});
};
	...
	return elm$http$Http$post(
		{
			...
			aK: elm$http$Http$expectString(author$project$User$ff),
			bb: 'https://cp.coindaq.net/api/getuserkey'
		});
};
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 4:
				var userMsg = msg.a;
				var _n2 = A2(author$project$User$update, userMsg, model.u);
				var user = _n2.a;
				var command = _n2.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				...
				if (!result.$) {
					var d = result.a;
					var data = A3(elm$core$Dict$insert, d.aS.aD, d, model.x);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{x: data}),
...
var author$project$Main$AddPair = {$: 3};
var author$project$Main$ToggleModal = {$: 1};
	...
	return A2(
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onClick(author$project$Main$AddPair)
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('options-view')
					]),
				_List_fromArray(
					[
						A2(
...
var author$project$User$Submit = {$: 2};
				...
				[
					...
					_List_fromArray(
						[
							...
							author$project$User$view(model.u))
						]))
				]));
	}
};
							...
							[
								...
								_List_fromArray(
									[
										...
										A2(author$project$View$Table$getRedOrGreenClass, d.aB.a$, d.aB.aF)
									]))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(d.aB.aF)
							])),
						A2(
						elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										_Utils_Tuple2('value', true),
										A2(author$project$View$Table$getRedOrGreenClass, d.az.a$, d.az.aF)
									]))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(d.az.aF)
							]))
					])),
				A2(
				elm$html$Html$td,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										_Utils_Tuple2('value', true),
										A2(author$project$View$Table$getRedOrGreenClass, d.aO.a$, d.aO.aF)
									]))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(d.aO.aF)
							])),
						A2(
						elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										_Utils_Tuple2('value', true),
										A2(author$project$View$Table$getRedOrGreenClass, d.aT.a$, d.aT.aF)
									]))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(d.aT.aF)
							]))
					])),
				A2(
				elm$html$Html$td,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										_Utils_Tuple2('value', true),
										A2(author$project$View$Table$getRedOrGreenClass, d.be.a$, d.be.aF)
									]))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(d.be.aF)
							])),
						A2(
						elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										_Utils_Tuple2('value', true),
										A2(author$project$View$Table$getRedOrGreenClass, d.aA.a0, d.aA.aG)
									]))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(d.aA.aG)
							])),
						A2(
						elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										_Utils_Tuple2('value', true),
										A2(author$project$View$Table$getRedOrGreenClass, d.aA.a9, d.aA.a0)
									]))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(d.aA.a0)
							]))
					])),
				A2(
				elm$html$Html$td,
			...
			[
				...
				_List_fromArray(
					[
						...
						A2(
							elm$core$List$map,
							author$project$View$Table$viewCeil,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												_Utils_Tuple2('value', true),
												A2(author$project$View$Tile$getRedOrGreenClass, d.aB.a$, d.aB.aF)
											]))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												_Utils_Tuple2('value', true),
												A2(author$project$View$Tile$getRedOrGreenClass, d.az.a$, d.az.aF)
											]))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												_Utils_Tuple2('value', true),
												A2(author$project$View$Tile$getRedOrGreenClass, d.aO.a$, d.aO.aF)
											]))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												_Utils_Tuple2('value', true),
												A2(author$project$View$Tile$getRedOrGreenClass, d.aT.a$, d.aT.aF)
											]))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												_Utils_Tuple2('value', true),
												A2(author$project$View$Tile$getRedOrGreenClass, d.aA.a0, d.aA.aG)
											]))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												_Utils_Tuple2('value', true),
												A2(author$project$View$Tile$getRedOrGreenClass, d.aA.a9, d.aA.a0)
											]))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												_Utils_Tuple2('value', true),
												A2(author$project$View$Tile$getRedOrGreenClass, d.be.a$, d.be.aF)
											]))
									]),
								_List_fromArray(
									[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				var _n0 = model.O;
				if (!_n0) {
					return author$project$View$Table$viewTable(model.x);
				} else {
					return author$project$View$Tile$viewTileList(model.x);
				}
			}()
			]));
};
...
var author$project$Main$main = elm$browser$Browser$element(
	{aR: author$project$Main$init, a6: author$project$Main$subscriptions, ba: author$project$Main$update, bd: author$project$Main$view});
